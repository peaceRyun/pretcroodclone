...
const MiniCard = ({ subtitle, p, isActive, onMouseEnter, onMouseLeave }) => {
    ...
    return (
        <div
            ref={cardRef}
            className='block rounded-3xl w-full text-left lg:flex lg:items-start lg:gap-4 p-7 lg:p-14 bg-zinc-900 text-white transition-all duration-0'
        ...
        >
            ...
            <p ref={paragraphRef} className='font-proxima-normal font-bold text-sm leading-6 lg:w-1/2'>
                {p}
            </p>
        </div>
    );
